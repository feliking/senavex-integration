                ...
                <div class="k-cuerpo">
                    ...
                    <form name="configuracionform" id="configuracionform" method="post"  action="index.php"  onkeypress="return anular(event)">
                        ...
                        <div class="row-fluid form" >
                            ...
                            <div class="span3 " >
                                <input type="text" class="k-textbox "  onkeypress='return validateQty(event);' placeholder="Numero de documento"  name="numerodocumentoconf" disabled id="numerodocumentoconf" value="{$numero_documento}" 
