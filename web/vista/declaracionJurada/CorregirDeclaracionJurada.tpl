            ...
            <div class="k-block fadein">
                <div class="k-header">
                    <div class="row-fluid form">
                        <div class="span12">
                            <div class="titulonegro"> Corregir Declaración Jurada</div> 
                        </div>
                    </div>  
                </div>
                <div class="k-cuerpo">
                    ...
                    <fieldset>
                        ...
                        <div class="row-fluid form">
                            ...
                            <div class="span4" >
                                <input type="text" class="k-textbox" placeholder="Denominación Comercial"  name="denominacion_comercial" id="denominacion_comercial" value="{$ddjj->getDescripcion_Comercial()}"  required validationMessage="Por favor ingrese Denominación Comercial" /> 
                            </div>
                            <div class="span2 parametro">
                                Nombre Técnico
                            </div>
                            <div class="span4" >
                                <input type="text" class="k-textbox" placeholder="Nombre Técnico"  name="nombre_tecnico" id="nombre_tecnico" value="{$ddjj->getNombre_tecnico()}"  required validationMessage="Por favor ingrese el Nombre Técnico"/>
                            </div>
                        </div>
                        <div class="row-fluid form">
                            <div class="span2 parametro">
                            ...
                            <div class="span4" >
                                <input type="text" class="k-textbox" placeholder="Características Técnicas"  name="caracteristicas" id="caracteristicas" value="{$ddjj->getCaracteristicas()}"  required validationMessage="Por favor ingrese Características Técnicas" />
                            </div>
                            <div class="span2 parametro">
                                Usos y aplicaciones:
                            </div>
                            <div class="span4" >
                                <input type="text" class="k-textbox" placeholder="Usos y aplicaciones" name="aplicacion" id="aplicacion" value="{$ddjj->getAplicacion()}"  required validationMessage="Por favor ingrese sus Usos y aplicaciones"/>
                            </div>
                        </div>
                    ...
                    <div class="row-fluid " >
                        <div class="span2 parametro">
                            Comentario para el Certificador:
                        </div>     
                        <div class="span10 campo" >
                            <textarea class="k-textbox" rows="2" id="comentario_general" name="comentario_general" placeholder="Comentario para el Certificador"></textarea>
                            <div class="span" ><center>
                                <input type="hidden" name="hiddenvalidatorcomgeneral" id="hiddenvalidatorcomgeneral" 
                                data-comgeneralvalidator
                                data-required-msg="Ingrese El Comentario" /></center>
                            </div> 
                        </div>
                    </div>
...
<div class="row-fluid fadein"  id="firmaenvioddjjcompleta" >
       <div class="k-block fadein">
                <div class="k-header">
                    <div class="k-header"><div class="titulo">Confirmación de Corrección de DD.JJ.</div></div>
                </div>
                <div class="k-cuerpo"> 
                    <div class="row-fluid  form" >
                        <div class="span1"> </div>
...
<script>
    ...
    firmarenvioddjjcompleta.bind("click", function(e){
        if(formfirmaenvioddjjcompleta.validate())
        {
            ...
            var datos = $("#editar_ddjj").serialize()+"&opcion=admDeclaracionJurada&tarea=actualizarDeclaracionJurada&corregir=1&tabla_nac="+arr_nac;
    ...
    function verificagridinsumosnacionales()
    {
        ...
        //Verificar los Acuerdos para Valor FOB y EXWORK
        {if ($apareceFob==1)}
            existe_fob=1;
        ...
        if((numfilas_nac==0)&&(numfilas_imp==0)){
            ...
            if(existe_exwork==1){
                if(total_nacionales >= valor_exwork){
                    return 6;
                }
            }
        }
