        ...
        <div class="span12" >
            <div class="k-block fadein">
                <div class="k-header">
                    <div class="row-fluid  form" >
                        <div class="span12" >
                            <div class="titulonegro" id="titulofactura" name="titulofactura" >Facturar Servicios - {$fmsucursalnombre}</div>  
                        </div>                                      
                    </div>  
                </div>
            ...
            <div class="row-fluid" >
                ...
                <div class="span10">
                    <div class="k-block fadein">
                        ...
                        <div class="k-cuerpo">
                            {if $dias_dosificacion < 30}
                                <div class="row-fluid  form" >
                                    <div class="span12" >
                                        {if $dias_dosificacion > 0 }
                                            <h2><strong>AVISO</strong> la dosificacion tiene {$dias_dosificacion} de vigencia</h2>
                                        {/if}
                                        {if $dias_dosificacion == 0 }
                            ...
                            <div class="row-fluid  form" >
                                ...
                                <div class="span6" >
                                    <input style="width:100%;" id="ruex_lista" name="ruex_lista" required validationMessage="Seleccione Nro RUEX" {if $dias_dosificacion < 0 }disabled{/if}/>
                                </div>
                            </div>
                        </div>
                        {if $fmsucursal==11 }
                        <div class="k-cuerpo">  
                            ...
                            <div class="row-fluid  form" >
                                <div class="span4 hidden-phone" ></div>
                                <div class="span4" >
                                    <input style="width:100%;" id="sucursal" name="sucursal" required validationMessage="Seleccione una Regional" {if $dias_dosificacion < 0 }disabled{/if}/>
                                </div>
                            </div>
                        </div>
                        {/if}
