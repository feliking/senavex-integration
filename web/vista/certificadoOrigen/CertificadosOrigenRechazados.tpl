<div class="row-fluid" class="fadein" >
    <div class="row-fluid  form" >
        <div id="certificadosorigenrechazados" class="fadein">
        </div>
    </div>
</div>
...
{literal}
 $(document).ready(function (){
    $("#certificadosorigenrechazados").kendoGrid({
        dataSource: {
            transport: {
                read: {
        ...
        columns: [
            ...
            { field: "observaciones", title: "Motivo de Rechazo"}
        ]
    });
});
...
{  
    var gridco = $("#certificadosorigenrechazados").data("kendoGrid");
