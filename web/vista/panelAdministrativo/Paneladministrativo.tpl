       ...
       <div class="span12" id="tabstripprincipal" >
            ...
            <div id="tabstrip">
                ...
                <div id="window"> 
                    ...
                    <div class="titulo"><p><a href='http://vcie.produccion.gob.bo/siexco/web/app.php/encuesta/{sha1($id_empresa)}' target="_blank">IR A LA ENCUESTA</a></p></div>
                </div>
            <script>
                print 
