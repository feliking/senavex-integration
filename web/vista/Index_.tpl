        ...
        <div class="container">
            ...
            <div class="row-fluid fadein" id="inicioprincipal">           
                ...
                <div class="row-fluid fadein form" id="comentarioregistrate2">
                    ...
                    <div class="span4"> 
                        <center> <span class="letrarelevanteroja" onclick="enviarregistrate()">Registrese aqu&iacute;</span></center> 
                    </div>
                    <div class="span4 hidden-phone"> 
                    </div>
                </div>
                        ...
                        <div class="k-block fadein"> 
                            ...
                            <div class="k-cuerpo">
                                <div class="row-fluid  form" >
                                    ...
                                    <div class="span10" >
                                        <p> Su <span class="letrarelevante">Usuario</span> y <span class="letrarelevante">Contraseña</span> han sido enviados a su correo electronico 
