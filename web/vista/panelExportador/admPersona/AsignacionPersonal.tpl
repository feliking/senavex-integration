            ...
            <input type="hidden" name="tarea" id="tarea" value="guardarPersonaExportador" /> 
                <div class="k-block fadein">
                    ...
                    <div class="k-cuerpo">
                        ...
                        <div class="row-fluid form" >
                            {include file="admDireccion/Direccion_Edit.tpl" de_id="asign1" tipo=3 direccion_id=0}
                            <!--div class="span4 " >
                                {literal}
...
<script> 
   ...
   // alert({$tipo});
    ...
    $("#idperfil").kendoComboBox(
        {   placeholder:"Perfil de Personal",
            ...
            { tipodocumento: "{$perfil->descripcion}", Id: {$perfil->id_perfil}},
            {/foreach}
            ],
            change : function (e) {
                //ocultar('div_nropoder');
   ...
   $("#expedido").kendoComboBox({   
        ...
        {foreach $datosdepartamento as $departamento }
            { sigla: "{$departamento.sigla}", Id: {$departamento.id_departamento} },
        {/foreach} 
        ],
        change : function (e) {
            if (this.value() && this.selectedIndex == -1) {
