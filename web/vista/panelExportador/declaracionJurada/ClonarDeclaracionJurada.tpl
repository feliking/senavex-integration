                ...
                <div class="k-cuerpo">
                    ...
                    <fieldset>
                        ...
                        <div class="row-fluid form" style="text-align: left;" >
                            <div class="span2" >
                                <input type="checkbox" name="lista_acuerdos[]" id="check_ace22" onclick="aparecer_fob(check_ace22)"{foreach from=$acuerdos item='ddjjacuerdo'} {if ($ddjjacuerdo->getId_acuerdo()==3)}checked{/if}{/foreach} value="ace22">ACE-22
                            </div>
                            <div class="span2" >
                                <input type="checkbox" name="lista_acuerdos[]" id="check_ace47" onclick="aparecer_fob(check_ace47); aparecer_Naladisa2007(check_ace47);"{foreach from=$acuerdos item='ddjjacuerdo'} {if ($ddjjacuerdo->getId_acuerdo()==4)}checked{/if}{/foreach} value="ace47">ACE-47
                            </div>
                            <div class="span2" >
                                <input type="checkbox" name="lista_acuerdos[]" id="check_arpar4" onclick="aparecer_fob(check_arpar4)"{foreach from=$acuerdos item='ddjjacuerdo'} {if ($ddjjacuerdo->getId_acuerdo()==6)}checked{/if}{/foreach} value="arpar4">AR.PAR N°4
                            </div>
                            <div class="span2" >
                                <input type="checkbox" name="lista_acuerdos[]" id="check_aapag" onclick="aparecer_fob(check_aapag)"{foreach from=$acuerdos item='ddjjacuerdo'} {if ($ddjjacuerdo->getId_acuerdo()==7)}checked{/if}{/foreach} value="aapag">AAP.AG N°2(Semillas)
                            </div>
                            <div class="span2" >
                                <input type="checkbox" name="lista_acuerdos[]" id="sgp_tp" onclick="aparecer_exwork(sgp_tp)"{foreach from=$acuerdos item='ddjjacuerdo'} {if ($ddjjacuerdo->getId_acuerdo()==18)}checked{/if}{/foreach} value="tp">TERCEROS PAISES
                            </div>
                        </div>
                        <div class="row-fluid form" style="text-align: left;">
                            <div class="span2" >
                                <input type="checkbox" name="lista_acuerdos[]" id="check_can" onclick="aparecer_fob(check_can)"{foreach from=$acuerdos item='ddjjacuerdo'} {if ($ddjjacuerdo->getId_acuerdo()==1)}checked{/if}{/foreach} value="can">CAN
                            </div>
                            <div class="span2" >
                                <input type="checkbox" name="lista_acuerdos[]" id="check_mercosur" onclick="aparecer_fob(check_mercosur)"{foreach from=$acuerdos item='ddjjacuerdo'} {if ($ddjjacuerdo->getId_acuerdo()==2)}checked{/if}{/foreach} value="mercosur">MERCOSUR
                            </div>
                            <div class="span2" >
                                <input type="checkbox" name="lista_acuerdos[]" id="check_venezuela" onclick="aparecer_fob(check_venezuela)"{foreach from=$acuerdos item='ddjjacuerdo'} {if ($ddjjacuerdo->getId_acuerdo()==5)}checked{/if}{/foreach} value="venezuela">VENEZUELA
                            </div>
                            <div class="span2" >
                                <input type="checkbox" name="lista_acuerdos[]" id="check_arampanama" onclick="aparecer_fob(check_arampanama); aparecer_Naladisa2007(check_arampanama);"{foreach from=$acuerdos item='ddjjacuerdo'} {if ($ddjjacuerdo->getId_acuerdo()==19)}checked{/if}{/foreach} value="arampanama">ARAM. PANAMÁ
                            </div>
                            <div class="span2" >
                                <input type="checkbox" name="check_sgt" {if ($apareceExWork==1)}checked{/if} id="check_sgt">SGP
                            </div>
                        </div>
                        
                        {if ($apareceExWork==1)}
                        <div class="row-fluid form" style="text-align: left;" id="div_sgt">
                        {else}
                        <div class="row-fluid form" style="text-align: left; display:none;" id="div_sgt">
                        {/if}
                            <fieldset><legend>REGIMENES PREFERENCIALES EN SGP</legend>
                            <div class="span3 " >
                            <input type="checkbox" name="lista_acuerdos[]" id="sgp_canada" onclick="aparecer_exwork(sgp_canada)"{foreach from=$acuerdos item='ddjjacuerdo'} {if ($ddjjacuerdo->getId_acuerdo()==8)}checked{/if}{/foreach} value="canada">CANADA
                            </div>
                            <div class="span3 " >
                            <input type="checkbox" name="lista_acuerdos[]" id="sgp_suiza" onclick="aparecer_exwork(sgp_suiza)"{foreach from=$acuerdos item='ddjjacuerdo'} {if ($ddjjacuerdo->getId_acuerdo()==9)}checked{/if}{/foreach} value="suiza">SUIZA
                            </div>
                            <div class="span3 " >
                            <input type="checkbox" name="lista_acuerdos[]" id="sgp_noruega" onclick="aparecer_exwork(sgp_noruega)"{foreach from=$acuerdos item='ddjjacuerdo'} {if ($ddjjacuerdo->getId_acuerdo()==10)}checked{/if}{/foreach} value="noruega">NORUEGA
                            </div>
                            <div class="span3 " >
                            <input type="checkbox" name="lista_acuerdos[]" id="sgp_japon" onclick="aparecer_exwork(sgp_japon)"{foreach from=$acuerdos item='ddjjacuerdo'} {if ($ddjjacuerdo->getId_acuerdo()==11)}checked{/if}{/foreach} value="japon">JAPON
                            </div>

                            <div class="span3 " >
                            <input type="checkbox" name="lista_acuerdos[]" id="sgp_zelanda" onclick="aparecer_exwork(sgp_zelanda)"{foreach from=$acuerdos item='ddjjacuerdo'} {if ($ddjjacuerdo->getId_acuerdo()==12)}checked{/if}{/foreach} value="zelanda">NUEVA ZELANDA
                            </div>
                            <div class="span3 " >
                            <input type="checkbox" name="lista_acuerdos[]" id="sgp_rusia" onclick="aparecer_exwork(sgp_rusia)"{foreach from=$acuerdos item='ddjjacuerdo'} {if ($ddjjacuerdo->getId_acuerdo()==13)}checked{/if}{/foreach} value="rusia">UNION ECONOMICA EUROASIATICA
                            </div>
                            <div class="span3 " >
                            <input type="checkbox" name="lista_acuerdos[]" id="sgp_turquia" onclick="aparecer_exwork(sgp_turquia)"{foreach from=$acuerdos item='ddjjacuerdo'} {if ($ddjjacuerdo->getId_acuerdo()==14)}checked{/if}{/foreach} value="turquia">TURQUÍA
                            </div>
                            <div class="span3 " >
                            <input type="checkbox" name="lista_acuerdos[]" id="sgp_bielorrusia" onclick="aparecer_exwork(sgp_bielorrusia)"{foreach from=$acuerdos item='ddjjacuerdo'} {if ($ddjjacuerdo->getId_acuerdo()==15)}checked{/if}{/foreach} value="bielorrusia">AUSTRALIA
                            </div>

                            <div class="span3 " >
                            <input type="checkbox" name="lista_acuerdos[]" id="sgp_ue" onclick="aparecer_exwork(sgp_ue)"{foreach from=$acuerdos item='ddjjacuerdo'} {if ($ddjjacuerdo->getId_acuerdo()==16)}checked{/if}{/foreach} value="ue">UNION EUROPEA
                            </div>
                            <div class="span3 " >
                            <input type="checkbox" name="lista_acuerdos[]" id="sgp_eeuu" onclick="aparecer_exwork(sgp_eeuu)"{foreach from=$acuerdos item='ddjjacuerdo'} {if ($ddjjacuerdo->getId_acuerdo()==17)}checked{/if}{/foreach} value="eeuu">ESTADOS UNIDOS
                            </div>
                            </fieldset>
                        </div>
                        ...
                        <div class="row-fluid">
                            {if ($apareceFob==1)}
                            <div class="span3" style="text-align: left;" id="div_fob">
                            {else}
                            <div class="span3" style="display:none; text-align: left;" id="div_fob">
                            {/if}
                                Valor FOB($us)<input type="text" placeholder="Valor FOB($us)" name="valor_fob" id="valor_fob" value="{$fob}" /> 
                            ...
                            {if ($apareceExWork==1)}
                            <div class="span3" style="text-align: left;" id="div_exwork">
                            {else}
                            <div class="span3" style="display:none; text-align: left;" id="div_exwork">
                            {/if}
                                Valor ExWork($us)<input type="text" placeholder="Valor ExWork($us)"  name="valor_exwork" id="valor_exwork" value="{$exwork}"/> 
                                <div class="span" ><center>
                    ...
                    <fieldset>
                        ...
                        {if ($aparece_naladisa93==1)}
                        <div class="row-fluid" style="text-align: left;" id="div_naladisa93">
                        {else}
                        ...
                        {if ($aparece_naladisa96==1)}
                        <div class="row-fluid" style="text-align: left;" id="div_naladisa96">
                        {else}
                        ...
                        {if ($aparece_naladisa2007==1)}
                        <div class="row-fluid"  style="text-align: left;" id="div_naladisa2007">
                        {else}
                        ...
                        {if ($aparece_naladisa91==1)}
                        <div class="row-fluid" style="text-align: left;" id="div_naladisa91">
                        {else}
                        ...
                        {if ($aparece_naladi83==1)}
                        <div class="row-fluid" style="text-align: left;" id="div_naladi83">
                        {else}
                    ...
                    <div class="row-fluid form" >
                        <div class="span8" >
                            <input id="combo_fabricas" name="combo_fabricas" style="width: 100%;" required validationMessage="Por favor ingrese una fábrica" />
                        </div>
                    ...
                    <fieldset>
                        ...
                        <div class="row-fluid form">
                            <div class="span6" >
                                <input type="text" class="k-textbox" placeholder="Denominación Comercial"  name="denominacion_comercial" id="denominacion_comercial" required validationMessage="Por favor ingrese Denominación Comercial" value="{$ddjj->getDescripcion_comercial()}" /> 
                            </div>
                            <div class="span6" >
                                <input type="text" class="k-textbox" placeholder="Nombre Técnico"  name="nombre_tecnico" id="nombre_tecnico" required validationMessage="Por favor ingrese el Nombre Técnico" value="{$ddjj->getNombre_tecnico()}"/>
                            </div>
                        </div>
                        <div class="row-fluid form">
                            <div class="span6" >
                                <input type="text" class="k-textbox" placeholder="Características Técnicas"  name="caracteristicas" id="caracteristicas" required validationMessage="Por favor ingrese Características Técnicas" value="{$ddjj->getCaracteristicas()}" />
                            </div>
                            <div class="span6" >
                                <input type="text" class="k-textbox" placeholder="Usos y aplicaciones" name="aplicacion" id="aplicacion" required validationMessage="Por favor ingrese sus Usos y aplicaciones" value="{$ddjj->getAplicacion()}"/>
                            </div>
                        </div>
                        <div class="row-fluid form" >
                            <div class="span4 " >
                            ...
                            <div class="span4 " >
                                <input type="text" placeholder="Capacidad de Producción Mensual" id="produccion_mensual" name="produccion_mensual" required validationMessage="Coloque la Cap. de Producción Mensual" value="{$ddjj->getProduccion_mensual()}">
                            </div>
                        </div>
                        <div class="row-fluid  form" >
                            <div class="span12" >
                            <input type="text" class="k-textbox "  placeholder="Descripción del Proceso Productivo"  name="procesoproductivo" id="procesoproductivo" required validationMessage="Por favor Especifique el Proceso Productivo" value="{$ddjj->getProceso_Productivo()}"/> 
                            </div>
                        </div>
                    </fieldset>
                    ...
                    <div class="row-fluid form" >
                        <div class="span12" >
                             ...
                             data-gridvalidator
                             data-required-msg="Por Favor Llene por lo menos un dato de Insumos Nacionales" />
                        </div>
                    </div>
                    <!-- BOTONES -->
                    <div class="row-fluid form" >
...
<script>
    ...
    */
    ...
    var apareceexwork = {$contar_exwork};
    ...
    var apareceNaladisa2007 = {$contar_naladisa2007};
    ...
    var alta_ddjj = $("#alta_ddjj").kendoValidator({
        ...
        messages:{
            ...
            gridvalidator: function(input) { 
                ...
                {    
                  return 'El valor puesto sobrepasa el valor FOB';
                }else if(swp==6)
                {    
                  return 'El valor puesto sobrepasa el valor EXWORK';
                }else if(swp==7)
                {  
    ...
    $(document).ready(function(){
        ...
        var nandina=$("#combonandina").kendoDropDownList({
        ...
        nandina.value({$detalle_arancel->getId_Detalle_Arancel()});
        
        //Combos para NALADISAS
        var naladisa93=$("#naladisa93").kendoDropDownList({
            cascadeFrom: "combocapitulos",
        ...
        naladisa93.value({$codigo_naladisa93});
            
        var naladisa96=$("#naladisa96").kendoDropDownList({
            cascadeFrom: "combocapitulos",
        ...
        naladisa96.value({$codigo_naladisa96});
        
        var naladisa2007=$("#naladisa2007").kendoDropDownList({
            cascadeFrom: "combocapitulos",
        ...
        naladisa2007.value({$codigo_naladisa2007});

        var naladisa91=$("#naladisa91").kendoDropDownList({
            cascadeFrom: "combocapitulos",
        ...
        naladisa91.value({$codigo_naladisa91});

        var naladi83=$("#naladi83").kendoDropDownList({
            cascadeFrom: "combocapitulos",
        ...
        naladi83.value({$codigo_naladi83});
