...
<body onload="document.ruex.razonsocial.focus();" style="overflow-x: hidden; position:relative;">
                    ...
                    <div class="k-block fadein">
                        ...
                        <div class="k-cuerpo">
                            <fieldset >
                                ...
                                <div class="row-fluid  form"  >
                                    <div class="span6" >
                                        <input type="text" style="width:100%;" class="k-textbox "  placeholder="Nombre o Razón Social"  name="razonsocial" id="razonsocial"  onkeyup="javascript:this.value=this.value.toUpperCase();" required validationMessage="Ingrese su Nombre o razón social" />
                                    </div>

                                    <div class="span6 " id="div_nombrecomercial" name="div_div_nombrecomercial">
                                        <input type="text" style="width:100%;" class="k-textbox "  placeholder="Nombre Comercial" name="nombrecomercial" id="nombrecomercial"  onkeyup="javascript:this.value=this.value.toUpperCase();" required validationMessage="Ingrese su Nombre Comercial"/>
                                    </div>
                                </div>
                                <div class="row-fluid form" >
                                     {literal}
