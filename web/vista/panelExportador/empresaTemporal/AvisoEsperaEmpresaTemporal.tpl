                            ...
                            <div class="k-block fadein">
                                ...
                                <div class="k-cuerpo">  
                                    <div class="row-fluid form" >
                                           <div class="span12" >
                                             <p> Felicidades!! Tu registro se lleno satisfactoriamente, se ha enviado el <span class="letrarelevante" >usuario</span> y <span class="letrarelevante" >contraseña</span> de tu empresa al email : <span class="letrarelevante" id='emailrlspan'>{$emailrp}</span><br>
