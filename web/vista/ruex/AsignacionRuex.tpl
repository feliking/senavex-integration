...
<div class="row-fluid fadein"  id="asignacionruex{$id}" >
    <div class="k-block">
        ...
        <div class="k-cuerpo">                
                 <div class="row-fluid " >
                    <div class="span2 {if $empresaRevision!=Null && $empresaRevision->razon_social!=$empresa_temporal->razon_social}parametro-modificado{else}parametro{/if}" >
                        Nombre o Razon Social:
                    </div>     
                    <div class="span5 campo" >
                        {$empresa_temporal->razon_social} 
                    </div>  
                    <div class="span2 {if $empresaRevision!=Null && $empresaRevision->nit!=$empresa_temporal->nit}parametro-modificado{else}parametro{/if}" >
                        NIT:
                    </div>     
                ...
                <div class="row-fluid " >
                    <div class="span2 {if $empresaRevision!=Null && $empresaRevision->nombre_comercial!=$empresa_temporal->nombre_comercial}parametro-modificado{else}parametro{/if}" >
                        Nombre Comercial:
                    </div>     
                    <div class="span5 campo" >
                        {$empresa_temporal->nombre_comercial} 
                    </div>
                    <div class="span2 {if $empresaRevision!=Null && $empresaRevision->certificacionnit!=$empresa_temporal->certificacionnit}parametro-modificado{else}parametro{/if}" >
                ...
                <div class="row-fluid " >                 
                    ...
                    {if $empresa_temporal->ico}
                        <div class="span1 {if $empresaRevision!=Null && $empresaRevision->ico!=$empresa_temporal->ico}parametro-modificado{else}parametro{/if}" > Nro ICO </div>
                        <div class="span1 campo" > {$empresa_temporal->ico} </div>
                    {else}
                        <div class="span2 hidden-phone" ></div>
                    {/if}
                    {if $empresa_temporal->matricula_fundempresa}
                        <div class="span2 {if $empresaRevision!=Null && $empresaRevision->matricula_fundempresa!=$empresa_temporal->matricula_fundempresa}parametro-modificado{else}parametro{/if}" >
                            Nro. FundEmpresa:
                        </div>     
                        <div class="span2 campo" >
                ...
                <div class="row-fluid " >
                    ...
                    {if $empresa_temporal->oea}
                            <div class="span4  {if $empresaRevision!=Null && $empresaRevision->oea!=$empresa_temporal->oea}parametro-modificado{else}parametro{/if}" >
                ...
                <div class="row-fluid  form" >
                    <div class="span2 {if $empresaRevision!=Null && $empresaRevision->ruex!=$empresa_temporal->ruex}parametro-modificado{else}parametro{/if}" >
                       Ruex:
                    </div>     
                    <div class="span2 campo" >
                         {$empresa_temporal->ruex}
                    </div>  
                    <div class="span2 {if $empresaRevision!=Null && $empresaRevision->vigencia!=$empresa_temporal->vigencia}parametro-modificado{else}parametro{/if}" >
                        Vigencia:
                    </div>     
                    <div class="span2 campo" >
                ...
                <div class="row-fluid  form" >
                    ...
                    <div class="span2 {if $empresaRevision!=Null && $empresaRevision->idactividad_economica!=$idactividad_economica}parametro-modificado{else}parametro{/if}" >
                        Actividad Economica:
                    </div>     
                    <div class="span2 campo" >
                    ...
                    {if $empresa_temporal->idtipo_empresa}      
                        <div class="span2 {if $empresaRevision!=Null && $empresaRevision->idtipo_empresa!=$idtipo_empresa}parametro-modificado{else}parametro{/if}" >
                            Tipo de Empresa:
                        </div>     
                        <div class="span2 campo" >
                ...
                <div class="row-fluid form" >
                 ...
                 <div class="row-fluid  form" >
                    ...
                    <div class="span3 {if $empresaRevision!=Null && $empresaRevision->date_fundacion!=$empresa_temporal->date_fundacion}parametro-modificado{else}parametro{/if}" >
                       Año de Fundacion:
                    </div>     
                    <div class="span2 campo" >
                         {$empresa_temporal->date_fundacion}
                    </div> 
                    <div class="span2 {if $empresaRevision!=Null && $empresaRevision->coordenada_lat!=$empresa_temporal->coordenada_lat}parametro-modificado{else}parametro{/if}" >
                       latitud(coordenadas):
                    </div>     
                    <div class="span2 campo" >
                ...
                <div class="row-fluid  form" >
                    <div class="span1 hidden-phone" ></div>
                    <div class="span3 {if $empresaRevision!=Null && $empresaRevision->date_inicio_operaciones!=$empresa_temporal->date_inicio_operaciones}parametro-modificado{else}parametro{/if}" >
                    ...
                    <div class="span2 {if $empresaRevision!=Null && $empresaRevision->coordenada_long!=$empresa_temporal->coordenada_long}parametro-modificado{else}parametro{/if}" >
                ...
                <div class="row-fluid  form" >
                    <div class="span2 {if $empresaRevision!=Null && $empresaRevision->descripcion_empresa!=$empresa_temporal->descripcion_empresa}parametro-modificado{else}parametro{/if}" >
                ...
                <div class="row-fluid form" >
                   <div class="span2 {if $empresaRevision!=Null && $empresaRevision->afiliaciones!=$afiliaciones_val}parametro-modificado{else}parametro{/if}" >
                            Afiliaciones:
                    </div>     
                    <div class="span9" >
              ...
              <div class="row-fluid  form" >
                ...
                <div class="row-fluid  form" >
                    <div class="span3 {if $empresaRevision!=Null && $empresaRevision->idrubro_exportaciones!=$idrubro_exportaciones}parametro-modificado{else}parametro{/if}" >
                ...
                {if $ico->ico}
                    <div class="row-fluid  form" >
                        <div class="span3 {if $empresaRevision!=Null && $empresaRevision->ico!=$empresa_temporal->ico}parametro-modificado{else}parametro{/if}" >
                            <b>Numero ICO:</b>
                        </div>     
                        <div class="span9 campo" >
                            {$ico->ico}
                ...
                <div class="row-fluid  form" >
                        <div class="span12 parametro" style="text-align: left;" >
                            {if $empresa_temporal->estado!=9}
                                Escriba si tiene observaciones en el registro de la empresa "{$empresa_temporal->razon_social}", se le notificará al exportador que su RUEX tiene Observaciones.
                            {else} 
                ...
                <div class="row-fluid" id="notificacionobservacionr{$id}">
                    ...
                    <div class="row-fluid  form" >
                        ...
                        {if $revisar=='1' || $revisar=='2' }
                            <div class="span3" >
                                <input id="rechazarruex{$id}" type="{if $revisar=='2'}hidden{else}button{/if}" value="Rechazar" class="k-primary" style="width:100%"/> <br><br>
                            </div>
                            <div class="span3" >
