...
<div id="planilla_registro_ddjj">
    {include file="admPlanilla/planilla_addddjj.tpl"} 
</div>
            ...
            if(dt.length>0){
                ...
                for(var num=1; num<dt.length ; num++){
                    if(dt[num].estado==0)
                    {
                        ...
                        $("#ver-"+num).kendoButton(); 
{*                        $("#ver-"+num).change(function(){*}
{*                            var cp = $(this).attr("id").split("-");*}
{*                            alert(cp);*}
{*                            cambiarDetalleRevision());*}
{*                        }); *}
...
{*    ComboboxDDJJCriteriosTodos("#ddjj_criterio-"+num_co+'-'+ddjj_fila);*}
{*    ComboboxDDJJCriterios("#ddjj_criterio-"+num_co+'-'+ddjj_fila, id_empresa);*}
                        ...
                        '<div class="span12" >'+
                            '<div class="k-block fadein">'+
                                ...
                                '<form name="formPlanillaDDJJ" id="formPlanillaDDJJ" method="post"  action="index.php"> '+
                                                '<input type="hidden" name="fmsucursalddjj" id="fmsucursalddjj" value="{$fmsucursal}" />'+
