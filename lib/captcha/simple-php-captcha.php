...
if( isset($_GET['_CAPTCHA']) ) {
	...
	$captcha = imagecreatefrompng($background);// creates new img
	
	$color = hex2rgb($captcha_config['color']);// translate hex to rgb
	$color = imagecolorallocate($captcha, $color['r'], $color['g'], $color['b']);// set the color of te text
	...
	imagettftext($captcha, $font_size, $angle, $text_pos_x, $text_pos_y, $color, $font, $captcha_config['code']);	
        ...
        for ($i = 0; $i < 5; $i++) {
            ...
            imagesetthickness($captcha, rand(1, 5));
            imagearc(
                $captcha,
                rand(1, 160), // x-coordinate of the center.
                rand(1, 75), // y-coordinate of the center.
                rand(1, 150), // The arc width.
                rand(1, 150), // The arc height.
                rand(1, 150), // The arc start angle, in degrees.
                rand(1, 150), // The arc end angle, in degrees.
                (rand(0, 1) ? $color : $color) // A color identifier.
            );
        }

	//imageline($captcha, $text_pos_x, $text_pos_y, 40, 40, $color);
	// Output image
