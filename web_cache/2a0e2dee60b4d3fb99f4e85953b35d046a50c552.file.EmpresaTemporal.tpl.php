<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-03-20 08:21:49
         compiled from "/enex/web1/sitio/web/vista/empresaTemporal/EmpresaTemporal.tpl" */ ?>
<?php /*%%SmartyHeaderCode:34912351557ceda559998b3-03986920%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2a0e2dee60b4d3fb99f4e85953b35d046a50c552' => 
    array (
      0 => '/enex/web1/sitio/web/vista/empresaTemporal/EmpresaTemporal.tpl',
      1 => 1521548324,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '34912351557ceda559998b3-03986920',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_57ceda55aa5b07_95006889',
  'variables' => 
  array (
    'afiliaciones_valores' => 0,
    'rubros_exportaciones' => 0,
    'rubro' => 0,
    'sw_bienvenida_temporal' => 0,
    'movil' => 0,
    'datostipoempresa' => 0,
...
<?php if ($_valid && !is_callable('content_57ceda55aa5b07_95006889')) {function content_57ceda55aa5b07_95006889($_smarty_tpl) {?><html >
<head>
                    ...
                    <div class="k-block fadein">
                        ...
                        <div class="k-cuerpo">
                            ...
                            <fieldset >
                                ...
                                <div class="row-fluid form" >
                                    <div class="span12 " >
                                        <input type="hidden" name="afifiliaciones_values" id="afiliaciones_values" value="<?php echo $_smarty_tpl->tpl_vars['afiliaciones_valores']->value;?>
" />
                            ...
                            <fieldset >
                                ...
                                <div class="row-fluid form" >
                                    <?php echo $_smarty_tpl->getSubTemplate ("admDireccion/Direccion_Edit.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('editable'=>true,'de_id'=>1,'tipo'=>2,'direccion_id'=>0), 0);?>
...
?>
                                <div class="row-fluid" >
                                    <div name="rubro-<?php echo $_smarty_tpl->tpl_vars['rubro']->value->id_rubro_exportaciones;?>
" id="rubro-<?php echo $_smarty_tpl->tpl_vars['rubro']->value->id_rubro_exportaciones;?>
">
                                        <div class="checkboxtemporal">
                                            ...
                                            <?php if ($_smarty_tpl->tpl_vars['rubro']->value->id_rubro_exportaciones=='4') {?>
                                                onclick="mostrarcafe(<?php echo $_smarty_tpl->tpl_vars['rubro']->value->id_rubro_exportaciones;?>
,this.checked);"
                                                id="checkboxcafe"
                                            <?php }?>
                                            <?php if ($_smarty_tpl->tpl_vars['rubro']->value->id_rubro_exportaciones=='8') {?>
                                                onclick="mostrarnim(<?php echo $_smarty_tpl->tpl_vars['rubro']->value->id_rubro_exportaciones;?>
,this.checked);"
                                                id="checkboxnim"
                                            <?php }?>
                                            value="<?php echo $_smarty_tpl->tpl_vars['rubro']->value->id_rubro_exportaciones;?>
"-->
                                            <input type="checkbox" name="rubroexportacionesarray[]" 
                                            <?php if ($_smarty_tpl->tpl_vars['rubro']->value->id_rubro_exportaciones=='4') {?>
                                                onclick="mostrarcafe(<?php echo $_smarty_tpl->tpl_vars['rubro']->value->id_rubro_exportaciones;?>
...
">
                            ...
                            <div id="div_datos_privados" name="div_datos_privados" > 
                                <?php echo $_smarty_tpl->getSubTemplate ("admDireccion/Direccion_Edit.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('editable'=>true,'de_id'=>2,'tipo'=>3,'direccion_id'=>0), 0);?>
...
> 
  ...
  <?php if (($_smarty_tpl->tpl_vars['sw_bienvenida_temporal']->value=="0")&&($_smarty_tpl->tpl_vars['movil']->value=="0")) {?>  <!--para la bienvenida del usuario temporal --> 
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['departamento']['last']       = ($_smarty_tpl->tpl_vars['smarty']->value['section']['departamento']['iteration'] == $_smarty_tpl->tpl_vars['smarty']->value['section']['departamento']['total']);
?>		
            { sigla: "<?php echo $_smarty_tpl->tpl_vars['datosdepartamento']->value[$_smarty_tpl->getVariable('smarty')->value['section']['departamento']['index']]['sigla'];?>
", Id: <?php echo $_smarty_tpl->tpl_vars['datosdepartamento']->value[$_smarty_tpl->getVariable('smarty')->value['section']['departamento']['index']]['id_departamento'];?>
 },
           <?php endfor; endif; ?> 
            ],
...
{
    if(value){
        var elem =  '<div id="div-ico" name="div-ico">'+
                                '<input type="text"'+
                                'class="k-textbox "'+
                                'pattern="[0-9]{4}"'+
                                'placeholder="ICO"'+
...
{
   if(estado){
        var elem='<div id="div_nim" name="div_nim"> <input class="span3 k-textbox" type="text" \n\
                placeholder="N&uacute;mero de Identificaci&oacute;n minera"  \n\
                name="nim" id="nim"  \n\
                pattern="[0-9]{2}-[0-9]{4}-[0-9]{2}"\n\
                required validationMessage="Ingrese su Nim, formato: ## - #### - ##" /></div>';
         $('#rubro-'+id).append(elem);    
   }else{
       $('#nim').html('');
        $("#div_nim").remove();
