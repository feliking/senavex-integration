<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-06-30 11:27:23
         compiled from "/enex/web1/sitio/web/vista/admPersona/guardarFirma.tpl" */ ?>
<?php /*%%SmartyHeaderCode:105086412257cede119fc054-74100529%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5e091ae43e075c7f21800a6ab64e94b26a8ad561' => 
    array (
      0 => '/enex/web1/sitio/web/vista/admPersona/guardarFirma.tpl',
      1 => 1498836204,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '105086412257cede119fc054-74100529',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_57cede11a19b81_03132725',
  'variables' => 
  array (
    'id_persona' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_57cede11a19b81_03132725')) {function content_57cede11a19b81_03132725($_smarty_tpl) {?><link rel="stylesheet" type="text/css" href="styles/css-personales/component.css" media="screen" />
    ...
    <div class="k-cuerpo fadein" id="cropImg">
        ...
        <div class="row-fluid form fadein" >
            <div class="span12 " >      
                ...
                <?php echo '<script'; ?>
 src="styles/js-personales/component.js"><?php echo '</script'; ?>
>
            </div> 
        </div> 
        <div class="row-fluid fadein" >
...
guardarFirma.bind("click", function(e){
    ...
    //------------------send serv-----------------------------------------
        ...
        $.ajax( {
           url: 'index.php',
           type: 'post',
           data:'opcion=funcionesGenerales&tarea=subirFirma&id_persona=<?php echo $_smarty_tpl->tpl_vars['id_persona']->value;?>
&imagen='+dataURL,
