<?php /* Smarty version Smarty-3.1.21-dev, created on 2019-08-22 09:31:12
         compiled from "/enex/web1/sitio/web/vista/ProForma/factura_manual_import.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18976311525c1a934813e592-57947629%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e3be0f8fc6936b43b7defa3277234019b51bbaaf' => 
    array (
      0 => '/enex/web1/sitio/web/vista/ProForma/factura_manual_import.tpl',
      1 => 1566480533,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18976311525c1a934813e592-57947629',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5c1a934820e287_76559341',
  'variables' => 
  array (
    'fmsucursalnombre_imp' => 0,
    'fmsucursal_imp' => 0,
    'nombrecompleto' => 0,
    'empresa' => 0,
    'servicios_imp' => 0,
...
<?php if ($_valid && !is_callable('content_5c1a934820e287_76559341')) {function content_5c1a934820e287_76559341($_smarty_tpl) {?><div class="row-fluid  form" >
            ...
            <div class="k-block fadein">
                <div class="k-header">
                    <div class="row-fluid  form" >
                        <div class="span12" >
                            <div class="titulonegro" id="titulofactura_imp" name="titulofactura_imp" >Facturar Servicios Importacion- <?php echo $_smarty_tpl->tpl_vars['fmsucursalnombre_imp']->value;?>
</div>  
                        </div>                                      
                    </div>  
                </div>
                ...
                <form name="formfacturamanual_imp" id="formfacturamanual_imp" method="post"  action="index.php"> 
                    ...
                    <input type="hidden" name="fmsucursal_imp" id="fmsucursal_imp" value="<?php echo $_smarty_tpl->tpl_vars['fmsucursal_imp']->value;?>
" />
...
> 
    ...
    if(<?php echo $_smarty_tpl->tpl_vars['fmsucursal_imp']->value;?>
==11){
 ...
 $_from = $_smarty_tpl->tpl_vars['servicios_imp']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
", Id: <?php echo $_smarty_tpl->tpl_vars['regional']->value->getId_regional();?>
 ...
 $_from = $_smarty_tpl->tpl_vars['listaCategorias']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['cate']->key => $_smarty_tpl->tpl_vars['cate']->value) {
$_smarty_tpl->tpl_vars['cate']->_loop = true;
?> 
                     { value: "<?php echo $_smarty_tpl->tpl_vars['cate']->value->getDescripcion();?>
", Id: <?php echo $_smarty_tpl->tpl_vars['cate']->value->getId_categoria_empresa();?>
 },
                <?php } ?>  
                ],
            });
            ...
            $('#empresa_depto').kendoComboBox({
                ...
                dataSource: [
                <?php  $_smarty_tpl->tpl_vars['regional'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['regional']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['listaDepartamento']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['regional']->key => $_smarty_tpl->tpl_vars['regional']->value) {
$_smarty_tpl->tpl_vars['regional']->_loop = true;
?> 
                     { value: "<?php echo $_smarty_tpl->tpl_vars['regional']->value->getNombre();?>
", Id: <?php echo $_smarty_tpl->tpl_vars['regional']->value->getId_departamento();?>
 },
                <?php } ?>  
                ],
            });
