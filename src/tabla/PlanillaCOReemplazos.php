...
class PlanillaCOReemplazos extends Db {
        
    const TABLE = 'planilla_co_reemplazos';
     ...
     * **/
    private $id_planilla_co_reemplazos;
    private $id_planilla_co;
    private $nro_control;
    private $nro_emision;
    
    function getId_planilla_co_reemplazos() {
        return $this->id_planilla_co_reemplazos;
    }
    ...
    function setId_planilla_co_reemplazos($id_planilla_co_reemplazos) {
        $this->id_planilla_co_reemplazos = $id_planilla_co_reemplazos;
    }
