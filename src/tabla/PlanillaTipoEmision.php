...
class PlanillaTipoEmision extends Db {
        
    const TABLE = 'planilla_tipo_emision';
    ...
    function getId_planilla_tipo() {
        return $this->id_planilla_tipo;
    }

    function setId_planilla_tipo($id_planilla_tipo) {
        $this->id_planilla_tipo = $id_planilla_tipo;
    }
}
