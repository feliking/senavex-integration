...
class Factura extends Db {
    ...
    (
        ...
        'insumosfactura'=>array(self::HAS_MANY,'InsumosFactura','id_factura'),
    ...
    public function setNumero_Autorizacion($numero_autorizacion) {
        $this->numero_autorizacion = $numero_autorizacion;
    }
    public function getNumero_Autorizacion() {
