...
/** CS|Acuerdo|acu|F **/
class DireccionUbicacionEdificio extends Db {
    
    const TABLE = 'direccion_ubicacion_edificio';
    ...
    private $id_direccion_ubicacion_edificio;
    private $descripcion; 
    
    function getId_direccion_ubicacion_edificio() {
        return $this->id_direccion_ubicacion_edificio;
    }
    ...
    function setId_direccion_ubicacion_edificio($id_direccion_ubicacion_edificio) {
        $this->id_direccion_ubicacion_edificio = $id_direccion_ubicacion_edificio;
    }
