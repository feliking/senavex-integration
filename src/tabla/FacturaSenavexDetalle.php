...
/** CS|Empresa|emp|T **/
class FacturaSenavexDetalle extends Db {
    
    const TABLE = 'factura_senavex_detalle';
    ...
    private $id_factura_senavex_detalle;
    ...
    function getId_factura_senavex_detalle() {
        return $this->id_factura_senavex_detalle;
    }
    ...
    function setId_factura_senavex_detalle($id_factura_senavex_detalle) {
        $this->id_factura_senavex_detalle = $id_factura_senavex_detalle;
    }
