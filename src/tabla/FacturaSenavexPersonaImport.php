...
/** CS|Empresa|emp|T **/
class FacturaSenavexPersonaImport extends Db {
    
    const TABLE = 'factura_senavex_persona_import';
    ...
    private $id_factura_senavex_persona_import;
    ...
    function getId_factura_senavex_persona_import() {
        return $this->id_factura_senavex_persona_import;
    }
    ...
    function setId_factura_senavex_persona_import($id_factura_senavex_persona_import) {
        $this->id_factura_senavex_persona_import = $id_factura_senavex_persona_import;
    }
