...
/** CD|Certificado Mercosur DDJJ Factura|co_mec_ddjj_fac|F **/
class COMercosurDdjjFactura extends Db {
        
    const TABLE = 'co_mercosurddjjfactura';

    //public $certificado_origen = array();
    
    public static $RELATIONS = array
    (
        'co_mercosur' => array(self:: BELONGS_TO, 'COMercosur', 'id_co_mercosur'),
   ...
   /** 1 llave primaria, foranea o campo (PK,FK,CP) | 
    ...
    /** PK|INT|CO-MERCOSUR-DDJJ-FACTURA|0|F|F|-|-|10|F **/
    private $id_co_mercosurddjjfactura;
    /** FK|INT|CO-MERCOSUR|0|F|F|-|-|10|F **/
    private $id_co_mercosur;
    /** PK|INT|DDJJ|0|F|F|-|-|10|F **/
    private $id_ddjj;
    /** PK|INT|FACTURA|0|F|F|-|F|- **/
    private $id_factura;
    /** PK|INT|Tipo de Factura|0|T|F|Seleccione tipo de Factura|-|10|T **/
    private $id_tipo_factura;
    /** CP|INT|Numero de Orden|0|F|F|-|-|10|F **/
    private $numero_orden;
    /** CP|INT|Denominacion Mercaderia|0|F|F|-|-|10|F **/
    private $denominacion_mercaderia;
    /** CP|NUMERIC|Peso/Cantidad|0|T|F|-|-|10|F **/
    private $peso_cantidad;
    /** CP|NUMERIC|Unidad de Medida|0|T|F|-|-|F|F **/
    private $unidad_medida;
    /** CP|NUMERIC|Valor FOB|0|F|F|-|-|10|F **/
    private $valor_fob;
    /** FK|INT|Tipo de Desglose|0|F|F|-|-|10|F **/
    private $id_tipo_desglose;
    
    public function setId_co_mercosurddjjfactura($id_co_mercosurddjjfactura) {
        $this->id_co_mercosurddjjfactura = $id_co_mercosurddjjfactura;
    }
    public function getId_co_mercosurddjjfactura() {
        return $this->id_co_mercosurddjjfactura;
    }
