...
{	
    ...
    {	
        ...
        $this->Cell(40,7,utf8_decode(''),0,0,'C',0);
        $this->Ln();
    ...
    function Footer()
    {
        ...
        if($co_mercosur->getId_datos_tercer_operador()!=0){
            ...
            //$factura_tercer_operador->setId_factura_tercer_operador($co_mercosur->getId_factura_tercer_operador());
            //$factura_tercer_operador=$sqlFacturaTercerOperador->getBuscarDatosTercerOperadorPorId($datos_tercer_operador);
            ...
            //var_dump($datos_tercer_operador);
        ...
        $this->Cell(70,5,utf8_decode(''),0,0,'L');
        $this->Ln(17);
        $this->SetFont('Times','B',9);
