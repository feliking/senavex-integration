...
echo 'Empresa '.$id_autorizacion_previa;  die;
$autorizacionPrevia->setId_autorizacion_previa((isset($_REQUEST['qkeeCer'])?$_REQUEST['qkeeCer']:$_SESSION['qkeeCer']));
...
$autorizacionPreviaDetalle->setId_autorizacion_previa($_REQUEST['qkeeCer']);
...
{   
    ...
    function CodigoQR($id_autorizacion_previa){
        ...
        $this->SetXY(140, 40);
        $this->Ln(38);
        $this->Cell(0,10,utf8_decode('AUTORIZACIÓN PREVIA DE'),0,0,'C');
        $this->Ln(10);
        $this->Cell(0,10,utf8_decode('IMPORTACIÓN '),0,0,'C');
        //$this->Ln(5);
...
{
    $pdf->Cell(40,4,utf8_decode('AUTORIZACION PREVIA DE IMPORTACION'),0,1,'C');
}
//$pdf->Cell(107,4,'',0,0);
