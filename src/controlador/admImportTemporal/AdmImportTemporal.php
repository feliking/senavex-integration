...
class AdmImportTemporal extends Principal {

  public function AdmImportTemporal() {
...
//        print('<pre>'.print_r($lista,true).'</pre>');
    ...
    //------------esto verifica si el usuario ya a registrado su empresa o no
        if($_SESSION["estado_usuario_temp"]=='2')  
        {
            ...
            $vista->display("importTemporal/AvisoEsperaEmpresaTemporal.tpl");
        }
        else
        {
            ...
            $vista->display("importTemporal/ImportTemporal.tpl");
        }
    }
}