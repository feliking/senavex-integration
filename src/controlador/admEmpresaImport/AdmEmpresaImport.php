...
class AdmEmpresaImport extends Principal {
    public function AdmEmpresaImport() 
    {
...
//            print('<pre>'.print_r($empresaRevision,true).'</pre>');
    ...
    //        
        ...
        {   
            ...
            $empresasruex=$sqlEmpresa->getListarEmpresaPorFechaDescendente($empresa);
            $vista->assign('empresasruex', $empresasruex);
        ...
        if($_REQUEST['tarea']=='agregarEmpresa_Import')
        {
            //print('<pre>'.print_r($_REQUEST,true).'</pre>');
            ...
            $FSEmpresa->setId_categoria_empresa($_REQUEST['empresa_categoria']);
            $FSEmpresa->setId_departamento($_REQUEST['empresa_depto']);
            ...
            if(empty($FSEmpresa)==true){
                ...
                echo '[';
                echo '{"id":"'.$FSEmpresa->getId_factura_senavex_empresa_import().'",'
      ...
      if($_REQUEST['tarea']=='aviso'){
            $vista->assign('id_empresa', $_REQUEST['id_empresa']);
            $vista->display("importTemporal/AvisoImportacionTemporal.tpl");
        }
