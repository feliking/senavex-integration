...
$empresa->setId_empresa((isset($_REQUEST['id_empresa'])?$_REQUEST['id_empresa']:$_SESSION['id_empresa']));
...
//        print('<pre>'.print_r($seguridadaux,true).'</pre>');
        ...
        //$codigo.=' http://vortex.senavex.gob.bo/ruex.php?datos='.$empresa->getCodigo_seguridad();
