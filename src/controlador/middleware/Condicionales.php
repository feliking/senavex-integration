...
class Condicionales
{
  ...
  private $id_registrar_tramites=4; // este es el id del perfil de unidad legal...
  ...
  public function esTramites()
  {
    return $_SESSION['id_perfil']==$this->id_registrar_tramites;
  }
